...
export default function CreateJob({
	...
	return (
		<>
			<div className="mx-auto bg-white p-4 rounded-[1rem] w-full">
				<div>
					<Form {...form}>
						<form onSubmit={form.handleSubmit(onSubmit)}>
									...
									return (
										<FormItem>
											...
											<FormControl>
												<Input
													className="rounded-[5px]"
													placeholder="Enter your job location name"
													{...field}
												/>
											</FormControl>
											<FormMessage className="text-red-500" />
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<RichTextEditor
												onEditorChange={(value) => form.setValue('JobDescription', value)}
												intialEditorText={JobDescription}
											/>
										</FormControl>
										<FormMessage className="text-red-500" />
									</FormItem>
							...
							<div className="">
								<FormLabel className="text-lg">Application Questions</FormLabel>
								<div>
											...
											<FormField
												...
												render={({ field }) => (
													<FormItem>
														...
														<div className="flex">
															<FormControl>
																<Input {...field} className="rounded-[5px] mx-auto " />
															</FormControl>
															{index > 0 && (
																<Button
																	variant="destructive"
