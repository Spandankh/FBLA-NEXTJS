        ...
        <div className="container px-5 py-10 mx-auto">
            <div className="grid md:grid-cols-3 gap-6 mt-6">
                <Card className=" bg-gradient-to-r from-[#0096C7]  to-[#00B4D8] border-black  rounded-[15px]">
                    ...
                    <CardContent>
                        <p className="text-[20px] text-gray-800">
                            Intergrity has played a massive role in forming the
                            relationship we have with our clients since the
                ...
                <Card className=" bg-gradient-to-r from-[#00B4D8] to-[#48CAE4] border-black  rounded-[15px]">
                    <CardHeader>
                        <CardTitle className="text-black text-[30px] font-semibold">
                            Innovation
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-[20px] text-gray-800">
                            At Wariom, we are always working to find new ways to
                            make sure our clients get the best possible
                            training.
                        </p>
                    </CardContent>
                ...
                <Card className=" bg-gradient-to-br from-[#48CAE4] to-[#90E0EF] border-black  rounded-[15px] max-w-prose">
                    ...
                    <CardContent>
                        <p className="text-[20px] text-gray-800">
                            At Wario, we embrace teamwork and cooperation to
